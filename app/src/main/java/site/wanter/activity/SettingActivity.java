...
import site.wanter.service.AddressService;
import site.wanter.service.BlackNumService;
import site.wanter.ui.SettingClickView;
import site.wanter.ui.SettingView;
import site.wanter.utils.AddressUtils;
...
public class SettingActivity extends Activity {
    ...
    private void blackNum() {
        if (AddressUtils.isRunningService(mContext,"site.wanter.service.BlackNumService")){
            //服务已经开启
    ...
    private void address(){
        if (AddressUtils.isRunningService(mContext,"site.wanter.service.AddressService")){
            //服务已经开启
